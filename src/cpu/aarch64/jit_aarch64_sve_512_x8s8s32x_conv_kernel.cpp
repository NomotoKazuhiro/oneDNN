...
template <>
void _jit_aarch64_sve_512_x8s8s32x_fwd_kernel<ZReg>::compute_ker_dw(int ur_w,
        int pad_l, int pad_r, ic_block_t last_ic_block_flag, bool h_padded) {
...
template <>
void _jit_aarch64_sve_512_x8s8s32x_fwd_kernel<ZReg>::vmm_mask_all_one() {
    mask_gflag = true;
...
template <>
void _jit_aarch64_sve_512_x8s8s32x_fwd_kernel<ZReg>::vmm_load_src(
        ZReg src, XReg reg_addr, bool mask_flag) {
    if (mask_flag) {
        eor(mask_tmp.b, mask_all_one, mask_tmp.b, mask_tmp.b);
        eor(mask_tmp2.b, mask_all_one, mask_tmp2.b, mask_tmp2.b);
...
template struct _jit_aarch64_sve_512_x8s8s32x_fwd_kernel<ZReg>;
#if 0
